...
#pragma warning restore 8500
        ...
        private static IntPtr RhpCidResolve_Worker(object pObject, IntPtr pCell)
        {
            ...
            EH.FallbackFailFast("Valid method implementation was not found.", RhFailFastReason.InternalError, null);
            return IntPtr.Zero;
        }
...
#else
                EH.FallbackFailFast("!SUPPORTS_NATIVE_METADATA_TYPE_LOADING_AND_SUPPORTS_TOKEN_BASED_DISPATCH_CELLS", RhFailFastReason.InternalError, null);
                return IntPtr.Zero;
#endif
            }
        }
