...
#pragma warning disable IDE0060
        ...
        internal static void FallbackFailFast(string? message, RhFailFastReason reason, object unhandledException)
        {
            InternalCalls.RhpFallbackFailFast(message ?? RuntimeExceptionHelpers.GetStringForFailFastReason(reason), (unhandledException is Exception) ? (Exception)unhandledException : null);
        }
